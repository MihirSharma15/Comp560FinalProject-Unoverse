...
def get_agent_configs() -> Dict[str, Dict]:
    ...
    return {
        ...
        "count_based_ultra_ultra_high_k": {
            "name": "Count-Based (k=100_000)",
            "class": AdaptiveEpsilonAgent,
            "params": {
                "learning_rate": 0.01,
                "initial_epsilon": 1.0,
        ...
        "threshold_high_thresholds": {
            "name": "Threshold-Based (high thresholds)",
            "class": AdaptiveEpsilonAgent,
            "params": {
                "learning_rate": 0.01,
                "initial_epsilon": 1.0,
        ...
        "threshold_low_thresholds": {
            "name": "Threshold-Based (low thresholds)",
            "class": AdaptiveEpsilonAgent,
            "params": {
                "learning_rate": 0.01,
                "initial_epsilon": 1.0,
